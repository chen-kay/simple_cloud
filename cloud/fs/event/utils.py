...
class Utils(ApiEvent):
    def originate_queue_test(self,
        ...
        msg = """bgapi originate {{sip_h_X-Phoneid={phoneId},sip_h_X-Proid={project_id},sip_h_X-Protype=1,cc_export_vars=sip_h_X-Phoneid,origination_caller_id_number={caller},effective_caller_id_number={encrypt},call_timeout=60,agent_timeout=5,originate_timeout=60}}sofia/gateway/{gateway}/{mobile} {queue_name} XML {domain}""".format( # noqa
            **{
                'phoneId': phoneId,
